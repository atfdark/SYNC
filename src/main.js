...
class WebBluetoothAudioSync extends EventEmitter {
    constructor(options = {}) {
        ...
        // Generate master peer ID first so it's available when constructing webrtcManager
    ...
    /**
     * Set the audio stream to send to mobile peers.
     * Pass the MediaStream from HTMLAudioElement.captureStream().
     * @param {MediaStream|null} stream
     */
    setMobileAudioStream(stream) {
        this.webrtcManager.setActiveAudioStream(stream);
        this.log.info('Mobile audio stream updated');
    }
